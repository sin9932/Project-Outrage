...
(function(g){
 ...
 const M={modelUrl:'../asset/model/mcv/mcv.glb?v=7',scale:20,modelScale:1.65,renderSpan:30,hqSpan:62,wheelRadius:.65,turnRate:7.5,deployTurnRate:20,seconds:.8,heading:Math.PI/2};
