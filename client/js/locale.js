...
(function(){
  ...
  const LOCALE = {
    ko: {
      ...
      "unit.mcv":"MCV", "unit.repair":"수리소", "pregame.mcvRedeploy":"MCV 재배치 가능", "unit.factory":"군수공장", "unit.radar":"레이더", "unit.turret":"센트리건",
      ...
      "ui.volume":"볼륨", "ui.music":"음악", "ui.brightness":"게임 밝기",
      "ui.modeRepair":"REPAIR", "ui.modeSell":"SELL",
      "ui.powerTip":"전력",
      "ui.avgHp":"평균 HP", "ui.minHp":"최소",
      // 프리게임
      ...
      "result.gameNum":"게임: 1", "result.kills":"킬수", "result.losses":"손실", "result.construction":"건설",
      "result.harvest":"자원수집량", "result.score":"점수", "result.continue":"계속",
    ...
    en: {
      ...
      "unit.mcv":"MCV", "unit.repair":"Service Depot", "pregame.mcvRedeploy":"Allow MCV redeployment", "unit.factory":"War Factory", "unit.radar":"Radar", "unit.turret":"Sentry Gun",
      ...
      "ui.volume":"Volume", "ui.music":"Music", "ui.brightness":"Game brightness",
      "ui.modeRepair":"REPAIR", "ui.modeSell":"SELL", "ui.powerTip":"Power",
      "ui.avgHp":"Avg HP", "ui.minHp":"Min",
      ...
      "result.gameNum":"Game: 1", "result.kills":"Kills", "result.losses":"Losses", "result.construction":"Built",
      "result.harvest":"Harvested", "result.score":"Score", "result.continue":"Continue",
    ...
    ja: {
      ...
      "unit.mcv":"MCV", "unit.repair":"修理施設", "pregame.mcvRedeploy":"MCV再展開を許可", "unit.factory":"軍需工場", "unit.radar":"レーダー", "unit.turret":"セントリーガン",
      ...
      "ui.volume":"音量", "ui.music":"音楽", "ui.brightness":"ゲーム明るさ",
      "ui.modeRepair":"REPAIR", "ui.modeSell":"SELL", "ui.powerTip":"電力",
      "ui.avgHp":"平均HP", "ui.minHp":"最小",
      ...
      "result.gameNum":"ゲーム: 1", "result.kills":"キル", "result.losses":"損失", "result.construction":"建設",
      "result.harvest":"収集量", "result.score":"スコア", "result.continue":"続ける",
