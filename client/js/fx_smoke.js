...
(function(){
  ...
  const smokeWaves = FX.smokeWaves = FX.smokeWaves || [];
  const smokePuffs = FX.smokePuffs = FX.smokePuffs || [];
  const smokeEmitters = FX.smokeEmitters = FX.smokeEmitters || [];
  const dustPuffs = FX.dustPuffs = FX.dustPuffs || [];
  const dmgSmokePuffs = FX.dmgSmokePuffs = FX.dmgSmokePuffs || [];
  ...
  Object.assign(FX, {
    ...
    spawnDustPuff, spawnDmgSmokePuff, addSmokeWave, spawnSmokePuff, spawnSmokeHaze, addSmokeEmitter, updateSmoke, drawSmokeWaves, drawSmokePuffs, drawDustPuffs, drawDmgSmokePuffs
  });
})();
