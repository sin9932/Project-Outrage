/* Fixed isometric factory: same 3x4 footprint/roof; right-wall cargo portal. */
(function(g){
 const clamp=v=>Math.max(0,Math.min(1,v));
 const F={modelUrl:'../asset/model/factory/factory.glb?v=2',scale:20,renderSpan:52,wheelRadius:1,heading:0,modelYaw:0,
 ...
 F.vehicle=(b,t,T)=>{const d=b._factoryDispatch;if(!d)return null;const p=clamp((t-d.started-F.doorSeconds)/F.driveSeconds),end=F.exit(b,T),start=b.x;
