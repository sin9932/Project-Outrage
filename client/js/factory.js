/* Factory: 3x4 tiles, 20 world units/metre, glTF +Z exits toward world +Y.
 * Simulation owns dispatch; renderer samples this state read-only. */
(function(g){
 const clamp=v=>Math.max(0,Math.min(1,v));
 const F={modelUrl:'../asset/model/factory/factory.glb',scale:20,renderSpan:52,wheelRadius:1,
 ...
 F.exit=(b,T)=>({x:b.x,y:(b.ty+b.th+.5)*T});
 F.accessRect=b=>({tx:b.tx+Math.floor(b.tw/2),ty:b.ty+b.th,tw:1,th:1});
