...
;(function(){
  // movement module (extracted)
  let issueMoveAll, buildFormationOffsets, aStarPath, findPath;
...
function footprintBlockedMask(tx,ty,tw,th){
  ...
  // --- movement module install (movement.js) ---
  ({ issueMoveAll, buildFormationOffsets, aStarPath, findPath } = createMovement({
    state,
    UNIT,
    INF_SLOT_MAX,
    MAP_W,
...
function heuristic(ax,ay,bx,by){
  ...
  // [moved] aStarPath -> js/movement.js
...
function stampCmd(e, type, x, y, targetId=null){
  ...
  // [moved] buildFormationOffsets -> js/movement.js


  
  // [moved] issueMoveAll -> js/movement.js
